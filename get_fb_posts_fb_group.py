...
#Generate your token https://developers.facebook.com/tools/explorer/
oa_token = "<FILL IN>" #DOUBLE DON'T SHARE THIS
app_id = "<FILL IN>"
app_secret = "<FILL IN>" # DO NOT SHARE WITH ANYONE!
group_id = "1507694412814471"
...
def scrapeFacebookPageFeedStatus(group_id, access_token):
    with open('%s_facebook_statuses.csv' % group_id, 'w', newline='') as file:
        w = csv.writer(file)
